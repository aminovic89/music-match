...
# tous les services Azure PROD
#
# NOTE : l'environnement DEV a été retiré (ressources
# supprimées, voir PR #26). Ce script ne recrée plus que PROD.
# ================================================
...
echo "→ Création de l'App Service plan (Free F1)..."
...
# Créer la database (--name, pas --database-name, depuis Azure CLI 2.6x+)
...
echo "================================================"
echo ""
echo "URL PROD : https://music-match-api-prod.azurewebsites.net"
echo "================================================"
