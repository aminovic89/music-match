...
| RESEND_API_KEY             | Render (apps/api)       | Clé API Resend (email de reset de mot de passe) |
| EMAIL_FROM                 | Render (apps/api)       | Adresse d'expédition (ex. domaine vérifié dans Resend) |
